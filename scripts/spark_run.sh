...
spark::print_info() {
  ...
  echo "  module load java/openjdk/java-${JAVA_VERSION}"
  echo "  module load spark/spark-${SPARK_VERSION}-hadoop${SPARK_HADOOP_VERSION}"
  echo "  spark-shell"
  echo "#-------------------------------------------------------------------------------"
  echo ""
  echo "#-------------------------------------------------------------------------------"
  ...
  echo "  module load java/openjdk/java-${JAVA_VERSION}"
  echo "  module load spark/spark-${SPARK_VERSION}-hadoop${SPARK_HADOOP_VERSION}"
  echo "  run-example \"org.apache.spark.examples.SparkPi\" \"2\""
  echo "#-------------------------------------------------------------------------------"
  echo ""
